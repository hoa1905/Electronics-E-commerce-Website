...
<body style= "background-color: rgb(245 245 245)"> 
  ...
  <?php 
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
      ...
      $gender = $_POST['gender'];
      $sql = "UPDATE users SET name = '$name', phone = '$phone', email = '$email', address = '$address', gender = '$gender' WHERE id = $id";
      ...
      <div class="container">
            ...
            <ul>
              ...
              <li class="clearfix">
                <div >
                  ...
                  <a href="./doi_mat_khau.php"><b class="name" style="padding-left: 25px">Đối mật khẩu</b><br></a>
                </div>
        ...
        <div class="col-md-9 bor" style="background-color: #fff">
          ...
          <div class="panel-body">
            ...
            ?>
            <form class="form-horizontal" action="ho_so_cua_toi.php" method="POST">
              <div class="form-group" style="text-align: center">
                <label class="col-sm-3 control-label" style="font-size: 13px">Tên đăng nhập </label>
                <div class="col-sm-7" style="display: inline-block">
                  <input type="text" class="form-control" placeholder="Tên đăng nhập" Value="<?php echo $row['name']?>" name="name" style="font-size: 13px">
                </div>
              </div>
              <div class="form-group" style="text-align: center">
                <label class="col-sm-3 control-label" style="font-size: 13px">Số điện thoại </label>
                <div class="col-sm-7" style="display: inline-block">
                  <input type="number" class="form-control" placeholder="Số điện thoại" Value="<?php echo $row['phone']?>" name="phone" style="font-size: 13px">
                </div>
              </div>
              <div class="form-group" style="text-align: center">
                <label class="col-sm-3 control-label" style="font-size: 13px">Email </label>
                <div class="col-sm-7" style="display: inline-block">
                  <input type="email" class="form-control" placeholder="Email" Value="<?php echo $row['email']?>" name="email" style="font-size: 13px">
                </div>
              </div>
              <div class="form-group" style="text-align: center">
                <label class="col-sm-3 control-label" style="font-size: 13px">Địa chỉ </label>
                <div class="col-sm-7" style="display: inline-block">
                  <input type="text" class="form-control" placeholder="Địa chỉ" Value="<?php echo $row['address']?>" name="address" style="font-size: 13px">
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-3 control-label" style="font-size: 13px">Giới tính </label>
                <?php if($row['gender'] === 'nu'){ ?>
                  <div class="col-sm-2" style="display: inline-block">
                    <input id="flexRadioDefault1" class="form-check-input" type="radio" name="gender" value="nam">
                    <label class="form-check-label" for="flexRadioDefault1">Nam</label>
                  </div>  
                  <div class="col-sm-2" style="display: inline-block">
                    <input id="flexRadioDefault1" class="form-check-input" type="radio" name="gender" value="nu" checked="true">
                    <label class="form-check-label" for="flexRadioDefault1">Nữ</label>
                  </div> 
                <?php } else{ ?>
                  <div class="col-sm-2" style="display: inline-block">
                    <input id="flexRadioDefault1" class="form-check-input" type="radio" name="gender" value="nam" checked="true">
                    <label class="form-check-label" for="flexRadioDefault1">Nam</label>
                  </div>  
                  <div class="col-sm-2" style="display: inline-block">
                    <input id="flexRadioDefault1" class="form-check-input" type="radio" name="gender" value="nu">
                    <label class="form-check-label" for="flexRadioDefault1">Nữ</label>
                  </div> 
                <?php } ?>
              </div>
