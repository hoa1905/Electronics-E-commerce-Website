      ...
      <ul class="pagination">
        <?php
          ...
          for($i = 1; $i <= $tongsotrang; $i++){
            if($trang == $i)
              echo "<li><a href='danh_muc_san_pham.php?iddanhmuc=${id_category}&name=$name_category&trang=${i}' class='active'>${i}</a></li>";
            else
              echo "<li><a href='danh_muc_san_pham.php?iddanhmuc=${id_category}&name=$name_category&trang=${i}'>${i}</a></li>";
          }
        ?>
      </ul>
    </nav>
